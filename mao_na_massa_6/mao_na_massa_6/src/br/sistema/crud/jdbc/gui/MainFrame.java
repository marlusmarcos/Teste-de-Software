	...
	*/
						...
						try {
							...
							tableListConsultaModel = 
									new DefaultTableModel(
											lista,
											new String[] { "Id", "Nome", "CPF", "Endere�o", "Sexo", "Dt. Nasc." });
	...
	private JPanel getPanelUpdate() {
		if(panelUpdate == null) {
			...
			panelUpdate.setBorder(BorderFactory.createTitledBorder("Edi��o de Pessoa"));
	...
	private JPanel getPanelEnderecoCadastro() {
		if(panelEnderecoCadastro == null) {
			...
			panelEnderecoCadastro.setBorder(BorderFactory.createTitledBorder("Endere�o"));
	...
	private JPanel getPanelEnderecoUpdate() {
		if(panelEnderecoUpdate == null) {
			...
			panelEnderecoUpdate.setBorder(BorderFactory.createTitledBorder("Endere�o"));
	...
	private JLabel getJLabel3() {
		if(lblNumeroUpdate == null) {
			...
			lblNumeroUpdate.setText("N�mero:");
		}
